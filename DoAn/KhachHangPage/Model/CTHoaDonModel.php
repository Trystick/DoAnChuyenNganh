...
class CTHoaDonModel
{
    ...
    public function updateChiTietHoaDon_TrangThai()
    {
        $dbCon = new MySQLUtils();
    ...
    public function getChiTietHoaDon_Theo_IDHD()
    {
        $dbCon = new MySQLUtils();
        $query = "SELECT TenSanPham, XuatXu, DonGia, SoLuong, ThanhTien FROM cthoadon WHERE ID_HoaDon = :idhd";
        $param = array(":idhd" => $this->getid_hd());
